...
<div class="container my-5 termsSection">
    <h2><strong>Terms and Conditions</strong></h2>

    <p class="txtPink">Welcome to CuDel!</p>

    <p>These terms and conditions outline the rules and regulations for the use of CUDEL DELIGHT SOLUTIONS PRIVATE
        LIMITED's Website, located at https://cudel.in/.</p>

    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use CuDel if you do
    ...
    <p>We employ the use of cookies. By accessing CuDel, you agreed to use cookies in agreement with the CUDEL DELIGHT
        SOLUTIONS PRIVATE LIMITED's Privacy Policy. </p>
    ...
    <p>Unless otherwise stated, CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED and/or its licensors own the intellectual
        property rights for all material on CuDel. All intellectual property rights are reserved. You may access this
        from CuDel for your own personal use subjected to restrictions set in these terms and conditions.</p>

    <p>You must not:</p>
    <div class="listing">
        <ul>
            <li>Republish material from CuDel</li>
            <li>Sell, rent or sub-license material from CuDel</li>
            <li>Reproduce, duplicate or copy material from CuDel</li>
            <li>Redistribute content from CuDel</li>
        </ul>
    </div>

    <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in certain
        areas of the website. CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED does not filter, edit, publish or review Comments
        prior to their presence on the website. Comments do not reflect the views and opinions of CUDEL DELIGHT
        SOLUTIONS PRIVATE LIMITED,its agents and/or affiliates. Comments reflect the views and opinions of the person
        who post their views and opinions. To the extent permitted by applicable laws, CUDEL DELIGHT SOLUTIONS PRIVATE
        LIMITED shall not be liable for the Comments or for any liability, damages or expenses caused and/or suffered as
        a result of any use of and/or posting of and/or appearance of the Comments on this website.</p>

    <p>CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED reserves the right to monitor all Comments and to remove any Comments
    ...
    <p>You hereby grant CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED a non-exclusive license to use, reproduce, edit and
    ...
    <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us look
        ...
        records with us; (c) the benefit to us from the visibility of the hyperlink compensates the absence of CUDEL
        DELIGHT SOLUTIONS PRIVATE LIMITED; and (d) the link is in the context of general resource information.</p>
    ...
    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website, you
        must inform us by sending an e-mail to CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED. Please include your name, your
    ...
    <p>No use of CUDEL DELIGHT SOLUTIONS PRIVATE LIMITED's logo or other artwork will be allowed for linking absent a
