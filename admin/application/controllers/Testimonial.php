<?php
    class Testimonial extends MY_Controller{
        ...
        public function index(){
		    ...
		    $items = $this->appmodel->select_all("testimonial", $where, $filters);

		    $data = [
			  'items'	=> $items
			];
			// print_r($items); die;
			$this->load->view('zimbra/testimonial/list', $data);
		}
		...
		public function create(){
			...
			if($post_data){
				...
				$isInsert = $this->appmodel->insert_one('testimonial', $insert_data);
				if($isInsert){
		    ...
		    $categories = $this->appmodel->select_all("testimonial", []);
		    $data = [
		    	'categories'			=> $categories
		    ];
		    $this->load->view('zimbra/testimonial/create', $data);
		}
		...
		public function edit($id){
			...
			if($post_data){
				...
				$isInsert = $this->appmodel->update('testimonial', $where, $insert_data);
				if($isInsert){
		    ...
		    $item = $this->appmodel->select_one("testimonial", $where);
		    $categories = $this->appmodel->select_all("testimonial", []);
		    $data = [
		    	'categories'			=> $categories,
		    	'item'   				=> $item  
		    ];
		    $this->load->view('zimbra/testimonial/edit', $data);
		}
		...
		public function delete($id){
			...
			$isDelete = $this->appmodel->delete_one("testimonial", $where);
			if($isDelete){
