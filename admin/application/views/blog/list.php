                     ...
                     <div class="card-header">
                        <div class="row">
                          ...
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('blog/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding-left: 20px;"><?=$value->details?></td>
                                                 <td style="padding-left: 20px;"><?=$value->benifits?></td>
                                                 <td style="padding-left: 20px;"><?=$value->price?></td>
                                                   <td style="padding-left: 20px;"><?=$value->discount?>%</td>
                                              ...
                                              <!--  -->
                                                <td style="padding-left: 20px;">
                                                    <a href="<?=site_url('blog/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>                                                 
                                                      
                                                    <a href="<?=base_url()?>blog/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
