               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('blog/create')?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="benefites" type="text" class="form-control" id="title" placeholder="Product Benefits ?">                                        
                                    </div>  
                                    <div class="form-group mb-3">
