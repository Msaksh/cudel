                     ...
                     <div class="card-header">
                        <div class="row">
                          ...
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('product/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                              ...
                              <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <!--  -->
                                                <td style="padding-left: 20px;">
                                                    <a href="<?=site_url('product/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>                                                 
                                                      
                                                    <a href="<?=base_url()?>product/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
