...
<head>
   <title><?=NAME?> | Blog Category List</title>
...
<body class="sidebar-mini fixed">
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">Blog Category List</h5>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="ul-widget_user-card">
                                                        ...
                                                        <?php if($value->image && file_exists(FCPATH.'/assets/images/category/'.$value->image)){ ?>
                                                          <img class="img-fluid" id="userDropdown" src="<?=base_url('/assets/images/category/'.$value->image)?>" alt="<?=$value->name?>" />
                                                          <?php }else{ ?>
                                                ...
                                                <td>
                                                    <label class="switch">
                                                     <input type="checkbox" <?php if($value->featured=='A'){ echo 'checked'; } ?> onclick="updateFeatured(this, <?=$value->id?>)" >
                                                     <span class="slider round"></span>
                                                  </label>
                                                </td>
                                                <td>
                                                    <a href="<?=site_url('blog_category/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a href="<?=base_url()?>blog_category/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
  ...
  <script>
            function updateStatus(event, id){
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>blog_category/enable",
                  data: data,
          ...
          function updateFeatured(event, id){
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>blog_category/featured",
                  data: data,
                  success: function(resultData) {
                    if(resultData){
