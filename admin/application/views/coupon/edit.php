               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('coupon')?>">Coupon Code</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Manage Coupon Code</a>
                        </li>
                     </ol>
                  </div>
               </div>
               ...
               <div class="col-sm-12">
                ...
                <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('coupon/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="coupon" type="text" value="<?=$item->coupon_code?>" class="form-control" id="title" placeholder="Coupon Code ?">                                        
                                    </div> 
                                     <div class="form-group mb-3">
                                        <label for="title">Price <span class="text-danger">*</span></label>
                                        <input name="price" type="text" value="<?=$item->price?>" class="form-control" id="title" placeholder="Price ?">                                        
                                    </div> 
                                 </div>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('coupon')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>
