...
<head>
   <title><?=NAME?> |Coupon Code List</title>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">Coupon Code List</h5>
                            <!-- <p>Basic example <code>without any additional modification</code> classes</p> -->
                          </div>
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('coupon/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                              ...
                              <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <!--  -->
                                                <td style="padding-left: 20px;">
                                                    <a href="<?=site_url('coupon/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>                                                 
                                                      
                                                    <a href="<?=base_url()?>coupon/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
