               ...
               <ul class="top-nav">
                  ...
                  <li class="dropdown">
                     <a href="#!" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false" class="dropdown-toggle drop icon-circle drop-image">
                        <span><img class="img-circle " src="<?=base_url()?>assets/cudel_logo.svg" style="width: 34px; height: 32px;" alt="User Image"></span>
                        <span><?=$this->session->userdata('profile')['name']?> <i class=" icofont icofont-simple-down"></i></span>

                     </a>
                     <ul class="dropdown-menu settings-menu">
                        <li><a href="<?=base_url('profile')?>"><i class="icon-user"></i> Profile</a></li>
                        <li><a href="<?=base_url('change-password')?>"><i class="icon-envelope-open"></i> Change Password</a></li>
                        <li class="p-0">
      ...
      <aside class="main-sidebar hidden-print ">
         <section class="sidebar" id="sidebar-scroll">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('service_rate_card')?>">
                        <i class="icon-event"></i><span> Services Card Rate</span>
                    </a>                
                </li>               
                <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('leads')?>">
                        <i class="icon-graph"></i><span>Customer Orders</span>
                    </a>                
                </li>   
                 <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('beautyexpert')?>">
                        <i class="icon-graph"></i><span>Beauty Expert Leads</span>
                    </a>                
                </li>           
               <li class="treeview">
                ...
                <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('pincode')?>">
                        <i class="fa-quote-left"></i><span> Add Zip Code</span>
                    </a>                
                </li> 
                 <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('coupon')?>">
                        <i class="fa-quote-left"></i><span> Add Coupon Code</span>
                    </a>                
                </li> 
                <li class="treeview">
                    <a class="waves-effect waves-dark" href="<?=base_url('service_card_category')?>">
                        <i class="icon-event"></i><span> Services Card Category</span>
                    </a>                
                </li>                           
