...
<head>
   <title><?=NAME?> | Pin Code Create</title>
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('pincode')?>">Pin Code</a>
                        <li class="breadcrumb-item"><a href="#">Add New Pin Code</a>
                        </li>
                     </ol>
                  </div>
               </div>
                            ...
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <label for="title">Pin Code <span class="text-danger">*</span></label>
                                        <input name="pin" type="text" class="form-control" id="title" placeholder="Area Pin Code ?">                                        
                                    </div>
                                </div>
                            </div>
                        </div>
