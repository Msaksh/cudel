               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('product')?>">Pin Code</a>
                        </li>
                        <li class="breadcrumb-item"><a href="#">Manage Pin Code</a>
                        </li>
                     </ol>
                  </div>
               </div>
                            ...
                            <div class="card p-10">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        <label for="title">Pin <span class="text-danger">*</span></label>
                                        <input name="pin" type="text" value="<?=$item->pin_code?>" class="form-control" id="title" placeholder="Are Pin Code ?">                                        
                                    </div> 
                                 </div>
                            </div>
                        </div>
