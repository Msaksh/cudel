...
<html>
<head>
    <title>Cudel || Payment Receipt</title>
                ...
                <div class="receipt-header">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                        <div class="receipt-right">
                            <h5>cuDel</h5>
                            <p>+91 9311147877 <i class="fa fa-phone"></i></p>
                            <p>cudelbooking@gmail.com <i class="fa fa-envelope-o"></i></p>
            ...
            <div class="row">
                <div class="receipt-header receipt-header-mid">
                    <div class="col-xs-8 col-sm-8 col-md-8 text-left">
                        <div class="receipt-right">
                            <h5>Krishna Bhardwaj <small>  |   Lucky Number : 420</small></h5>
                            <p><b>Mobile :</b> +91 12345-6789</p>
                            <p><b>Email :</b> info@gmail.com</p>
                            <p><b>Address :</b> Kutumbh care</p>
                        </div>
                    </div>
