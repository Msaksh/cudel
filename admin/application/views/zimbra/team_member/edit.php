...
<head>
   <title><?=NAME?> | Team Member Edit</title>
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="<?=base_url('zimbra_team_member')?>">Team member</a>
                        </li>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block" style="min-height: 525px;">
                        <form action="<?=base_url('zimbra_team_member/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea name="description" class="form-control" rows="4" placeholder="Description"><?=$item->description?></textarea>
                                    </div>
                                     <div class="form-group mb-3">
                                        <label for="excerpt">HearOnDescription <span class="text-danger">*</span></label>
                                        <textarea name="HearOnDescription" class="form-control" rows="4" placeholder="HearOnDescription"><?=$item->HearOnDescription?></textarea>
                                    </div>
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('zimbra_team_member')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>                  

                        <div class="card mt-3 p-10">
                            <div class="card-body">
                                <div class="card-title">Team Member Image
