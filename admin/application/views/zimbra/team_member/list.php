...
<head>
   <title><?=NAME?> | Team Member List</title>
...
<body class="sidebar-mini fixed">
               ...
               <div class="col-sm-12 p-0">
                  <div class="main-header">
                     ...
                     <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                        ...
                        <li class="breadcrumb-item"><a href="#">Team Member</a>
                        </li>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">Team Member List</h5>
                            <p>Basic example <code>without any additional modification</code> classes</p>
                          </div>
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('zimbra_team_member/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                              ...
                              <table class="table" id="myTable">
                                            <thead>
                                                <tr class="ul-widget6__tr--sticky-th">
                                                    ...
                                                    <th scope="col">HearOnDescription</th>
                                                    <th scope="col">CreateAt</th>
                                                    <th scope="col">HearOn</th>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <label class="switch">
                                                     <input type="checkbox" <?php if($value->HearOn=='A'){ echo 'checked'; } ?> onclick="updateHearOn(this, <?=$value->id?>)" >
                                                ...
                                                <td>
                                                    <a href="<?=base_url('zimbra_team_member/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a href="<?=base_url()?>zimbra_team_member/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
  ...
  <script>
            function updateStatus(event, id){
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>zimbra_team_member/enable",
                  data: data,
          ...
          function updateHearOn(event, id){
              var checked = 'D';
              if ($(event).is(':checked')) {
              checked = 'A';
              }
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>zimbra_team_member/HearOn",
                  data: data,
                  success: function(resultData) {
                    if(resultData){
                        success('successfully update HearOn');
                    }
                  }
              });
          }
          ...
          function updateFeatured(event, id){
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>zimbra_team_member/featured",
                  data: data,
                  success: function(resultData) {
                    if(resultData){
