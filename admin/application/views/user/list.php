...
<head>
   <title>Social Planet | User List</title>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">User List</h5>
                            <p>Basic example <code>without any additional modification</code> classes</p>
                          </div>
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('user/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="ul-widget_user-card">
                                                        ...
                                                        <?php if($value->image && file_exists(FCPATH.'/assets/images/user/'.$value->image)){ ?>
                                                          <img style="height: 68px;" id="userDropdown" src="<?=base_url('/assets/images/user/'.$value->image)?>" alt="<?=$value->name?>" />
                                                          <?php }else{ ?>
                                                ...
                                                <td>
                                                    <a href="<?=site_url('user/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a href="<?=base_url()?>user/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
