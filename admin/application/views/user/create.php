...
<head>
   <title>Social Planet | User Create</title>
               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('user/create')?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card">
                                <div class="card-body">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="name" type="text" class="form-control" id="name" placeholder="Customer Full Name">
                                    </div>
                                    <div class="row">
                                        <div class="col-sm-4">
                                            <div class="form-group mb-3">
                                                <label for="mobile">Mobile <span class="text-danger">*</span></label>
                                                <input name="mobile" type="text" class="form-control" id="mobile" placeholder="Customer Mobile">
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="email" type="text" class="form-control" id="email" placeholder="Customer Email">
                                    </div>
                                </div>
                            </div>
                        </div>
