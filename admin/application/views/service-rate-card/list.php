...
<head>
   <title><?=NAME?> | Service Card List</title>
...
<body class="sidebar-mini fixed">
                     ...
                     <div class="card-header">
                        <div class="row">
                          ...
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('service_rate_card/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                              ...
                              <table class="table" id="myTable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <!--  -->
                                                <td style="padding-left: 20px;">
                                                    <a href="<?=site_url('service_rate_card/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>                                                 
                                                      
                                                    <a href="<?=base_url()?>service_rate_card/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
  ...
  <script>
            function updateStatus(event, id){
              ...
              $.ajax({
                  type: 'POST',
                  url: "<?=base_url()?>service_rate_card/enable",
                  data: data,
