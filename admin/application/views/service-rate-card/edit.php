               ...
               <div class="col-sm-12">
                ...
                <div class="card">
                     <div class="card-block">
                        <form action="<?=base_url('service_rate_card/edit/'.$item->id)?>" id="form" method="post"  enctype="multipart/form-data">
                    <div class="row mt-3">
                        <div class="col-sm-9">
                            <div class="card p-10">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                       ...
                                       <?php foreach($categories as $value){ ?>
                                            <option value="<?=$value->id?>" <?=in_array($value->id, explode(',',$item->service_id))?'selected':''?>><?=$value->name?></option>
                                          <?php } ?>                                      
                        ...
                        <div class="col-sm-3">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="<?=base_url('service_rate_card')?>" class="btn btn-sm btn-outline-info btn-rounded m-1">Cancel</a>
                                </div>
                            </div>
                             ...
                             <div class="card p-10">
                                <div class="card-body">
                                    ...
                                    <div class="text-center">
                                        <?php if($item->image && file_exists(FCPATH.'/assets/images/rate-card/'.$item->image)){ ?>
