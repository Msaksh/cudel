                            ...
                            <div class="card p-10">
                                <div class="card-body">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="price" type="text" class="form-control" id="title" placeholder="Enter Price"  value="<?=$item->price?>">
                                    </div>

                                     <div class="form-group mb-3">
                                        <label for="editor">Details</label>
                                        <textarea name="des2" value="<?=$item->des2?>" id="editor"><?=$item->des2?></textarea>
                                    </div>
