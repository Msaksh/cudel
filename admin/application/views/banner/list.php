                     ...
                     <div class="card-header">
                        <div class="row">
                          ...
                          <div class="col-sm-6 text-right"> 
                            <a href="<?=base_url('banner/create')?>" class="btn btn-success"><i class="icon-plus"></i></a>
                          </div>
                        </div>
                              ...
                              <table class="table" id="myTable">
                                            <thead>
                                                <tr class="ul-widget6__tr--sticky-th">
                                                    ...
                                                    <th scope="col">Description First</th>
                                                    <th scope="col">Description Second</th>                                                   
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="ul-widget_user-card">
                                                        ...
                                                        <?php if($value->image && file_exists(FCPATH.'/assets/images/banner/'.$value->image)){ ?>
                                                          <img class="img-fluid" id="userDropdown" src="<?=base_url('/assets/images/banner/'.$value->image)?>" alt="<?=$value->name?>" />
                                                          <?php }else{ ?>
                                                ...
                                                <td>
                                                    <a href="<?=site_url('banner/edit/'.$value->id)?>" class="btn btn-success">
                                                        <i class="icon-pencil"></i>
                                                    </a>
                                                    <a href="<?=base_url()?>banner/delete/<?=$value->id?>" class="btn btn-danger delete" type="button">   
