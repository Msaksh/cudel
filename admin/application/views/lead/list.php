               ...
               <div class="col-sm-12">
                  ...
                  <div class="card">
                     <div class="card-header">
                        <div class="row">
                          <div class="col-sm-6"> 
                            <h5 class="card-header-text">Leads Management</h5>
                        ...
                        <div class="row">
                           <div class="col-sm-12 table-responsive">
                              <table class="table" id="myTable">
                                    ...
                                    $customer = $this->appmodel->select_one('customer',$where);?>
                                    
                                            <tr>
                                                <td> <?=++$i?> </td>
                                                <td><?=@$customer->name?></td> 
                                                <td><?=@$customer->phone?></td><td><a href="mailto:<?=@$customer->email?>"><?=@$customer->email?></a></td> 
                                                <td><?=@$customer->address?></td>  
                                                <td><?=@$value->created_at ?></td>                                 
                                                <td>
                                                    <a href="<?=site_url('leads/edit/'.$value->order_id)?>" class="btn btn-success">
                                                        <i class="icon-eye"></i>
                                                    </a>
                                                </td>
                                            </tr>
